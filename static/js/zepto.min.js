...
!function( t, e ) {
  ...
  var e,
    n; return c[ t ] || ( e = f.createElement( t ), f.body.appendChild( e ), n = getComputedStyle( e, "" ).getPropertyValue( "display" ), e.parentNode.removeChild( e ), "none" == n && ( n = "block" ), c[ t ] = n ), c[ t ];
} function U( t ) {
  ...
  L = Array.isArray || function( t ) {
    ...
    if ( !e || !t || 1 !== t.nodeType ) {
      return !1;
    } var n = t.matches || t.webkitMatchesSelector || t.mozMatchesSelector || t.oMatchesSelector || t.matchesSelector; if ( n ) {
        return n.call( t, e );
      } var r,
      i = t.parentNode,
    ...
    var o,
      s,
      a; return d.test( t ) && ( o = r( f.createElement( RegExp.$1 ) ) ), o || ( t.replace && ( t = t.replace( m, "<$1></$2>" ) ), n === e && ( n = p.test( t ) && RegExp.$1 ), n in j || ( n = "*" ), a = j[ n ], a.innerHTML = `${ t}`, o = r.each( u.call( a.childNodes ), function() {
        a.removeChild( this );
...
} ), r.fn = { constructor: N.Z, length: 0, forEach: o.forEach, reduce: o.reduce, push: o.push, sort: o.sort, splice: o.splice, indexOf: o.indexOf, concat: function() {
  var t,
    e,
  ...
  var e,
    n = this; return e = t ? "object" == typeof t ? r( t ).filter( function() {
  ...
  var n = [],
    i = "object" == typeof t && r( t ); return this.each( function( r, o ) {
  ...
  if ( e ) {
    ...
    return { top: 0, left: 0 };
  } var n = this[ 0 ].getBoundingClientRect(); return { left: n.left + t.pageXOffset, top: n.top + t.pageYOffset, width: Math.round( n.width ), height: Math.round( n.height ) };
}, css: function( t, e ) {
  ...
  var o = i % 2; r.fn[ n ] = function() {
    ...
    var c = h( t ),
     p = a[ c ] || ( a[ c ] = [] ); n.split( /\s/ ).forEach( function( n ) {
      ...
      } var a = d( n ); a.fn = i, a.sel = s, a.e in l && ( i = function( t ) {
  ...
  var e,
   ...
   l = { mouseenter: "mouseover", mouseleave: "mouseout" }; u.click = u.mousedown = u.mouseup = u.mousemove = "MouseEvents", e.event = { add: y, remove: x }, e.proxy = function( t, n ) {
    ...
    var r,
    i; return this.each( function( o, a ) {
  ...
  if ( n.dataFilter == j ) {
    return t;
  } var r = n.context; return n.dataFilter.call( r, t, e );
  ...
  h = r.createElement( "a" ); h.href = t.location.href, e.active = 0, e.ajaxJSONP = function( i, o ) {
  ...
  }, e.ajaxSettings = { type: "GET", beforeSend: j, success: j, error: j, complete: j, context: null, global: !0, xhr: function() {
    ...
    var u,
      ...
      a = e.Deferred && e.Deferred(); for ( i in e.ajaxSettings ) {
        ...
        p = /\?.+=\?/.test( s.url ); if ( p && ( c = "jsonp" ), s.cache !== !1 && ( n && n.cache === !0 || "script" != c && "jsonp" != c ) || ( s.url = T( s.url, `_=${ Date.now()}` ) ), "jsonp" == c ) {
        ...
        } var A = "async" in s ? s.async : !0; if ( N.open( s.type, s.url, A, s.username, s.password ), s.xhrFields ) {
